...
func NewRecipesHandler(ctx context.Context, collection *mongo.Collection, redisClient *redis.Client) *RecipesConfig {
...
func (app *RecipesConfig) CreateRecipeHandler(c *gin.Context) {
...
func (app *RecipesConfig) ListRecipesHandler(c *gin.Context) {
...
func (app *RecipesConfig) UpdateRecipeHandler(c *gin.Context) {
	id := c.Param("id")
	var recipe models.Recipe
	if err := c.ShouldBindJSON(&recipe); err != nil {
...
func (app *RecipesConfig) GetRecipeHandler(c *gin.Context) {
	id := c.Param("id")
	objectId, _ := primitive.ObjectIDFromHex(id)
...
func (app *RecipesConfig) DeleteRecipeHandler(c *gin.Context) {
	id := c.Param("id")
	objectId, _ := primitive.ObjectIDFromHex(id)
...
func (app *RecipesConfig) SearchRecipesHandler(c *gin.Context) {
	tag := c.Query("tag")
